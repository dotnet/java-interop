...
public static class XmlImporter
{
	...
	public static CallableWrapperType ImportType (XElement xml)
	{
		...
		var partial_assmbly_qualified_name = xml.GetRequiredAttribute ("partial_assmbly_qualified_name");

		var type = new CallableWrapperType (name, package, partial_assmbly_qualified_name) {
	...
	static void FillInMethodDetails (CallableWrapperMethod method, XElement xml)
	{
		...
		method.IsDynamicallyRegistered = xml.GetAttributeOrDefault ("is_dynamically_registered", true);
