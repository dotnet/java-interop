...
namespace Java.Interop {
	...
	static class RuntimeFeature {
		...
		internal static bool ManagedPeerNativeRegistration { get; } =
			AppContext.TryGetSwitch ($"{FeatureSwitchPrefix}{nameof (ManagedPeerNativeRegistration)}", out bool isEnabled) ? isEnabled : ManagedPeerNativeRegistrationEnabledByDefault;
	}
}
